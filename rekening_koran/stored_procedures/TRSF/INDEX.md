...
| [SP_TRSF_FindBTP_Batch.sql](SP_TRSF_FindBTP_Batch.sql) | 15KB | Batch search (returns multiple rows for multiple BTPs) | All use cases |
...
| File | Size | Tests |
|------|------|-------|
| [Test_SP_TRSF.sql](Test_SP_TRSF.sql) | 15KB | 9 comprehensive test cases |
...
T1   | SEJIWA COFFEE ADIT | 2300014842 | 98.81  | 1      | YES      | BEST
T1   | SEJIWA COFFEE ADIT | 2300015678 | 95.24  | 2      |          | LATEST
```
...
EXEC SP_TRSF_FindBTP_Batch @InputJSON = N'[
    {"transaction_id": "1", "description": "TRSF 12345 CUSTOMER NAME"}
]';
```
...
- **Deploy batch SP** → [SP_TRSF_FindBTP_Batch.sql](SP_TRSF_FindBTP_Batch.sql)
- **Test everything** → [Test_SP_TRSF.sql](Test_SP_TRSF.sql)

# SP_TRSF_FindBTP_Batch - Multiple Rows Feature

## 🎯 Your Request

> "kayak nya lebih bagus v1 deh, tapi kalau ditemukan 2 btp, tinggal return atau  
> munculkan data 2x, misalkan SEJIWA COFFEE ADIT itu memiliki 2 btp, return 2x  
> SEJIWA COFFEE ADIT nya, 1 dengan btp apa, persetase berapa bla bla bla, 1 nya  
...
## ✅ Solution: Updated SP_TRSF_FindBTP_Batch
...
**Input:** CHRISTIAN (has 2 BTPs)

**Output:** 1 row only
```
TransactionID | CustomerName | BTP        | MatchPct | TotalBTPOptions | Message
TRX001       | CHRISTIAN    | 2300014842 | 98.81    | 2              | Found 2 BTP options. Returning BEST.
```
...
TRX001       | CHRISTIAN    | 2300014842 | 98.81    | 1           | YES      |            | BEST
TRX001       | CHRISTIAN    | 2300015678 | 95.24    | 2           |          | YES        | LATEST
```
...
├──────┼──────────────────┼────────────┼───────┼────────┼─────────┼───────────┼─────────────────┤
│ T2   │ CHRISTIAN        │ 2300014842 │ 98.81 │ 1      │ YES     │           │ BEST            │ ⬅️ Row 1 for T2
│ T2   │ CHRISTIAN        │ 2300015678 │ 95.24 │ 2      │         │ YES       │ LATEST          │ ⬅️ Row 2 for T2
├──────┼──────────────────┼────────────┼───────┼────────┼─────────┼───────────┼─────────────────┤
...
DECLARE @JSON NVARCHAR(MAX) = N'[
    {"transaction_id": "TEST", 
     "description": "TRSF E-BANKING CR 1304 683280.00 fresh milk CHRISTIAN"}
]';

EXEC SP_TRSF_FindBTP_Batch @InputJSON = @JSON, @Debug = 1;

-- Expected: 2 rows if CHRISTIAN has 2 BTPs

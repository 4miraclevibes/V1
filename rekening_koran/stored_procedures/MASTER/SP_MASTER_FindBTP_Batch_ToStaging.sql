...
--
-- Description:
--   Execute SP_MASTER_FindBTP_Batch dan save hasil ke REKENING_KORAN_STAGING
--
-- Parameters:
--   @TransactionsJSON - JSON array of transactions
--   @BatchID - Optional batch identifier (auto-generate jika NULL)
--   @UploadedBy - Optional username/email
--
-- Returns:
--   Result set dari SP_MASTER_FindBTP_Batch + summary
--
-- Example:
...
PRINT '';
PRINT '✅ SP_MASTER_FindBTP_Batch_ToStaging created successfully!';
PRINT '';
PRINT '═══════════════════════════════════════════════════════════════════════';
PRINT 'Usage:';
PRINT '  DECLARE @JSON NVARCHAR(MAX) = N''[...]'';';
PRINT '  EXEC SP_MASTER_FindBTP_Batch_ToStaging ';

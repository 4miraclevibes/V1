...
--
-- Description:
--   Find BTP (Bill To Party) for DBS bank transactions (batch processing)
--   
-- Extraction Logic:
--   Group 2: Array[4] + Array[5] (Smart PT/CV)
--   Format: "KR OTOMATIS LLG-DBS INDONESIA [WORD1] [WORD2] [WORD3]..."
--   
...
CREATE OR ALTER PROCEDURE [dbo].[SP_DBS_FindBTP_Batch]
...
BEGIN
    ...
    PRINT '═══════════════════════════════════════════════════════════════════════';
    PRINT 'SP_DBS_FindBTP_Batch - Processing Complete';
    PRINT '═══════════════════════════════════════════════════════════════════════';
...
PRINT '✅ SP_DBS_FindBTP_Batch created successfully';
PRINT '   Bank: DBS';

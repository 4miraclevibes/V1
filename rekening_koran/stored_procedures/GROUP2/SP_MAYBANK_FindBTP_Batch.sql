...
--
-- Description:
--   Find BTP (Bill To Party) for MAYBANK bank transactions (batch processing)
--   
-- Extraction Logic:
--   Group 2: Array[4] + Array[5] (Smart PT/CV)
--   Format: "KR OTOMATIS LLG-MAYBANK INDONE [WORD1] [WORD2] [WORD3]..."
--   
--   Special Word: "INDONE" at Array[3] (automatically skipped)
--   
--   Extraction:
...
CREATE OR ALTER PROCEDURE [dbo].[SP_MAYBANK_FindBTP_Batch]
...
BEGIN
    ...
    BEGIN
        ...
        -- Special word "INDONE" at Array[3] is skipped
        -- ═══════════════════════════════════════════════════════════════════
        ...
        BEGIN
            ...
            SELECT 
                ...
                ROW_NUMBER() OVER (
                    ORDER BY 
                        CASE WHEN category = 'MAYBANK' THEN 1 ELSE 2 END,
            ...
            WHERE customer_name = @CustomerName
              AND (category = 'MAYBANK' OR category = 'NEW')
            ORDER BY 
                CASE WHEN category = 'MAYBANK' THEN 1 ELSE 2 END,
                match_percentage DESC,
                last_line_number DESC,
    ...
    PRINT '═══════════════════════════════════════════════════════════════════════';
    PRINT 'SP_MAYBANK_FindBTP_Batch - Processing Complete';
    PRINT '═══════════════════════════════════════════════════════════════════════';
...
PRINT '✅ SP_MAYBANK_FindBTP_Batch created successfully';
PRINT '   Bank: MAYBANK';
PRINT '   Group: 2 (Array[4] + Array[5])';
PRINT '   Special Word: INDONE';

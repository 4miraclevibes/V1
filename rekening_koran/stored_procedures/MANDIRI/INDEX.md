# 📚 MANDIRI BTP Matching - Documentation Index
...
|------|------|---------|----------|
| [SP_MANDIRI_FindBTP_Single.sql](SP_MANDIRI_FindBTP_Single.sql) | 7.4KB | Single transaction search | Real-time lookup |
| [SP_MANDIRI_FindBTP_Batch.sql](SP_MANDIRI_FindBTP_Batch.sql) | 15KB | Batch search (returns multiple rows for multiple BTPs) | All use cases |
...
| File | Size | Tests |
|------|------|-------|
| [Test_SP_MANDIRI.sql](Test_SP_MANDIRI.sql) | 15KB | 9 comprehensive test cases |
...
T1   | KOPERASI KARYAWAN | 2300015239 | 98.81  | 1      | YES      | BEST
T1   | KOPERASI KARYAWAN | 2300015240 | 95.24  | 2      |          | LATEST
```
...
:r ../../pattern_generator_MANDIRI/master_customer_btp_pattern_MANDIRI_SPLIT.sql

-- 2. Create stored procedures
:r SP_MANDIRI_FindBTP_Single.sql
:r SP_MANDIRI_FindBTP_Batch.sql
...
EXEC SP_MANDIRI_FindBTP_Batch @InputJSON = N'[
    {"transaction_id": "1", "description": "MANDIRI 12345 CUSTOMER NAME"}
]';
```
...
- **Deploy batch SP** → [SP_MANDIRI_FindBTP_Batch.sql](SP_MANDIRI_FindBTP_Batch.sql)
- **Test everything** → [Test_SP_MANDIRI.sql](Test_SP_MANDIRI.sql)

...
-- =====================================================
-- Purpose: Find BTP dari multiple deskripsi BIFAST (Batch via JSON)
...
DECLARE @JSON NVARCHAR(MAX) = N'[
    {
        ...
        "description": "BIFAST E-BANKING CR 1304/FTSCY/WS95011 683280.00 fresh milk 36pcs 15/04/2024 CHRISTIAN"
    },
    {
...
/*
DECLARE @JSON NVARCHAR(MAX) = N'[
    {"transaction_id": "T1", "description": "BIFAST E-BANKING CR 0201 455520.00 RONNY YULIADY"},
    {"transaction_id": "T2", "description": "BIFAST FROM BCA 123456789 CHRISTIAN"},
    {"transaction_id": "T3", "description": "BIFAST ONLINE PAYMENT 555.00 BROOKLYN BOGA UTAM"},
    {"transaction_id": "T4", "description": "BIFAST ATM 100000 PANCIOUS TIRTA JAY"}
]';
...
/*
DECLARE @JSON NVARCHAR(MAX) = N'[
    {"transaction_id": "TX1", "description": "BIFAST 12345 CHRISTIAN"},
    {"transaction_id": "TX2", "description": "BIFAST 67890 RONNY YULIADY"}
]';

-- Get all options
SELECT * 
INTO #AllResults
FROM [dbo].[SP_BIFAST_FindBTP_Batch](@JSON, 0);
...
/*
DECLARE @JSON NVARCHAR(MAX) = N'[
    {"description": "BIFAST 001 CUSTOMER A"},
    {"description": "BIFAST 002 CUSTOMER B"},
    {"description": "BIFAST 003 CUSTOMER C"}
]';

...
REM ke \\10.54.20.8\sap\shd\hris\sap_in\zaffie001\input
REM =====================================================
...
copy /Y "%NEWEST%" "\\10.54.20.8\sap\shd\hris\sap_in\zaffie001\input\"

if errorlevel 0 (
    echo Berhasil copy ke \\10.54.20.8\sap\shd\hris\sap_in\zaffie001\input
) else (

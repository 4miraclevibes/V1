...
// Fungsi untuk test large sample
void test_large_sample() {
    ...
    printf("📂 Testing large sample dari TRSF.csv...\n\n");
    ...
    printf("🔄 Processing... (testing 10,000 samples)\n");
    
    while (fgets(line, sizeof(line), file) && total_tested < 10000) {
        total_tested++;
        ...
        for (int i = 0; i < pattern_count; i++) {
            ...
            // Simple substring match (like the original test_btp_pattern)
    ...
    printf("\n");
    printf("═══════════════════════════════════════════════════════════════════\n");
    printf("                      LARGE SAMPLE TEST RESULTS\n");
    printf("═══════════════════════════════════════════════════════════════════\n");
...
int main() {
    printf("\n╔═══════════════════════════════════════════════════════════════════╗\n");
    printf("║                                                                   ║\n");
    printf("║           LARGE SAMPLE TEST TOOL v1.0                            ║\n");
    printf("║           Test 10,000 transactions for accuracy                   ║\n");
    printf("║                                                                   ║\n");
    printf("╚═══════════════════════════════════════════════════════════════════╝\n");

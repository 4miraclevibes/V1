...
-- =====================================================
-- Purpose: Table-Valued Function untuk filter BTP_REVIEW berdasarkan text fields
...
-- =====================================================
-- Usage di Power Apps:
--   FN_BTP_REVIEW_FilterText('customer', 'batch', 'desc', 'bank', 'btp')
--   atau dengan parameter named:
--   FN_BTP_REVIEW_FilterText(@SearchCustomer='customer', @SearchBTP='btp')
-- =====================================================

CREATE OR ALTER FUNCTION [dbo].[FN_BTP_REVIEW_FilterText] (

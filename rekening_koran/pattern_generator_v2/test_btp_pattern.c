...
void manual_test() {
    ...
    printf("(contoh: TRSF E-BANKING CR 0201/FTSCY/WS95011 455520.00 RONNY YULIADY)\n");
    printf("───────────────────────────────────────────────────────────────────\n");
    printf("Desc: ");
...
void print_menu() {
    ...
    printf("  5. Test batch dari TRSF.csv (1,000 sample)\n");
    printf("  6. Test batch dari TRSF.csv (5,000 sample)\n");

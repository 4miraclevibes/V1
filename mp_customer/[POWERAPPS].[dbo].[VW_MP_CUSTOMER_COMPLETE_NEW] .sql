...
/****** Object:  View [dbo].[VW_MP_CUSTOMER_COMPLETE_NEW]    Script Date: 11/11/2025 11:11:48 ******/
...
CREATE OR ALTER                                                   VIEW [dbo].[VW_MP_CUSTOMER_COMPLETE_NEW] AS
...
WHERE c.id IN (
    ...
    GROUP BY code, distributor_id, status

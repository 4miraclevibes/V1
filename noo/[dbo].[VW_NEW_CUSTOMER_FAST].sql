...
/****** Object:  View [dbo].[VW_NEW_CUSTOMER_FAST]    Script Date: 02/10/2025 09:36:00 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER     VIEW [dbo].[VW_NEW_CUSTOMER_FAST]
...
FROM (
    ...
    SELECT
        ...
        CASE WHEN CONVERT(CHAR(6),CAST(ISNULL(sm.[Create Date],'1900/1/1') AS DATETIME),112)
             ...
             IN (CONVERT(CHAR(6),GETDATE(),112), CONVERT(CHAR(6),DATEADD(DAY,-10,GETDATE()),112))
